  ...
  <div class="col-2 logoDiv d-flex align-items-center justify-content-center">
    <span v-if="screenType == 'mobile'">
      <a v-on:click="useToggleMobileMenu"
        ><img
          src="../assets/tree_full_green.png"
          class="logo me-2"
        />TradeNote</a
      >
    </span>
    ...
    <div class="sideMenuDiv">
      <div class="sideMenuDivContent">
        ...
        <a
          id="step7"
          v-bind:class="[
            pageId === 'screenshots' ? 'activeNavCss' : '',
            'nav-link',
            'mb-2',
          ]"
          href="/screenshots"
